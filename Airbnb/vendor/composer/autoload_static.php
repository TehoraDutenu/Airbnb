...
class ComposerStaticInit2032906f7db44897c013f2e3a29d0b23
{
    ...
    public static $classMap = array (
        ...
        'Core\\Controller\\ControllerInterface' => __DIR__ . '/../..' . '/Core/Controller/ControllerInterface.php',
        'Core\\Database\\Database' => __DIR__ . '/../..' . '/Core/Database/Database.php',
        'Core\\Database\\DatabaseConfigInterface' => __DIR__ . '/../..' . '/Core/Database/DatabaseConfigInterface.php',
        'Core\\Form\\FormError' => __DIR__ . '/../..' . '/Core/Form/FormError.php',
        'Core\\Form\\FormResult' => __DIR__ . '/../..' . '/Core/Form/FormResult.php',
        'Core\\Model\\Model' => __DIR__ . '/../..' . '/Core/Model/Model.php',
        'Core\\Repository\\AppRepoManager' => __DIR__ . '/../..' . '/Core/Repository/AppRepoManager.php',
        'Core\\Repository\\Repository' => __DIR__ . '/../..' . '/Core/Repository/Repository.php',
        'Core\\Repository\\RepositoryManagerTrait' => __DIR__ . '/../..' . '/Core/Repository/RepositoryManagerTrait.php',
        'Core\\Session\\Session' => __DIR__ . '/../..' . '/Core/Session/Session.php',
        'Core\\Session\\SessionManager' => __DIR__ . '/../..' . '/Core/Session/SessionManager.php',
